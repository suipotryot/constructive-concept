...
var DRAWASHAPE = (function (_) {
    ...
    this.Scene = function (options) {
        ...
        var ratio = window.innerWidth/2/window.innerHeight;

        // Set the Camera 2D of the scene
        this.camera2D = _.extend(new THREE.OrthographicCamera(
            this.options.cam2Dleft * ratio,
            this.options.cam2Dright * ratio,
        ...
        light = new THREE.DirectionalLight(0x778866, 1);
        ...
        if (webglAvailable()) {
            ...
            this.renderer2D.setClearColor(0x332233);
            this.renderer2D.setSize(window.innerWidth/2, window.innerHeight);
            this.renderer3D = new THREE.WebGLRenderer();
            this.renderer3D.setClearColor(0xf0f0f0);
            this.renderer3D.setSize(window.innerWidth/2, window.innerHeight);
        } else {
